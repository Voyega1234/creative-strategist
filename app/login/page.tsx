...
function MainContent() {
  ...
  const [isRedirectingToV2, setIsRedirectingToV2] = useState(false)
  ...
  // Show loading while checking authentication or redirecting authenticated users to home.
  if (isCheckingAuth || isRedirectingToV2 || isAuthenticated) {
    return (
      <div className="flex min-h-screen bg-white items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[#8e8e93]">
            {isCheckingAuth ? "กำลังตรวจสอบการเข้าสู่ระบบ..." : "กำลังเปิด Creative Compass..."}
          </p>
        </div>
      </div>
    )
